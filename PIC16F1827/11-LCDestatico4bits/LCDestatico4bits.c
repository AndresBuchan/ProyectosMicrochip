...
// 2x16 (Pantalla de cristal liquido), con conexión a 4 bits                 //
// El display se controla por el puerto B
///////////////////////////////////////////////////////////////////////////////
...
void main(){
    ...
    while(1){                           // Inicio del código a ejecutar constantemente
        ...
        while(1){
            continue;                   // Terminamos con un ciclo infinito en el cual nada hace
                                        // puesto que ya enviamos el mensaje
        }
    }
}
